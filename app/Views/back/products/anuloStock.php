...
<div class="container">
     ...
     <form method="post"  action="<?= site_url('/products/anulo') ?>">
      <input type="hidden" name="ID" value="<?php echo $producto['ID']; ?>">

    <div class="row">
        
         <div class="col-md-6"><h3>¿Seguro que deseas dar de baja el Stock de <?php echo $producto['Nombre']; ?> ?</h3></div>
