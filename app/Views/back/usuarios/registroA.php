<meta charset="utf-8">
  ...
  <link href="/pineyro_juan_P2/assets/css/miestilo.css" rel="stylesheet" >  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">

<body>
  <div class="container">
<h2>Registro de Administrador</h2>

<form class="row g-3" method="post" id="createUsuario" action="<?= site_url('/usuario_a/store') ?>">
...
<?php if (! empty ($errors)){ echo $errors['localidad']; }?></p>
  ...
  <div class="col-md-2"><p style="color: red;">
<?php if (! empty ($errors)){ echo $errors['CodPostal']; }?></p>
  ...
  <div class="col-12">
    <button type="submit" class="btn btn-primary" style="border-color: black; background-color: #454545;">Registrar</button>
  </div>
</form>  
</div>
</body>
